...
iD("Add").onclick = function () {
	...
	//   this.checked ? qSel(".tableCheck").style.display = "none" && qSel(".listCheck").style.display = "block" : qSel(".listCheck").style.display = "none" && qSel(".tableCheck").style.display = "block"
	//}
iD("typeList").onclick = function () {
	if (this.checked) {
		qSel(".tableCheck").style.display = "none";
		qSel(".listCheck").style.display = "block";
		iD("typeTable").checked = false;
	}
}
